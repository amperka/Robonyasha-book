...
/*
(1) Заведём переменную V для хранения напряжения на моторах. Если захотим задать другое значение,
    достаточно будет изменить число в одной строчке, а не искать и исправлять его по всему коду.
(10-18) Увеличим число функций марсохода. Если на ИК-пульте нажата кнопка BOTTOM, едем назад.
